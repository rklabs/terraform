...
type MockEvalContext struct {
	...
	ProviderSchemaAddr   addrs.ProviderConfig
...
func (c *MockEvalContext) Provider(addr addrs.ProviderConfig) ResourceProvider {
	c.ProviderCalled = true
	c.ProviderAddr = addr
	return c.ProviderProvider
}

func (c *MockEvalContext) ProviderSchema(addr addrs.ProviderConfig) *ProviderSchema {
